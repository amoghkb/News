...
class _PoliticsState extends State<Politics> with AutomaticKeepAliveClientMixin {
  ...
  Future<void> Getpolitics() async {
    final String Url =
        "https://newsapi.org/v2/everything?q=politics&from=2025-01-20&sortBy=publishedAt&apiKey=$API_key";
